#ifndef _AXMSCONSTANTS_H_
#define _AXMSCONSTANTS_H_
...
#define asDELIVERYSTATUS_SUBMITREQUESTED			10	// Submit requested
#define asDELIVERYSTATUS_SUBMITTED					11	// Submitted
#define asDELIVERYSTATUS_FAILED						12	// Failed
#define asDELIVERYSTATUS_NOCREDITS					13	// No credits

// SMPP Delivery Report Format

#define asSMPPDELIVERYREPORTFORMAT_HEX				0	// Hex message reference
#define asSMPPDELIVERYREPORTFORMAT_DEC				1	// Dec message reference
...
#define asMMS_VERSION_6_8_0							18	// MMS 3GPP Version 6.8.0
...
#define asMMS_SCHEMA_REL6_MM7_1_4					10	// MM7 XML SCHEMA REL-6-MM7-1-4

...
ServerDoc.h, ServerDoc.cpp - the document
    These files contain your CServerDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CServerDoc::Serialize).

ServerView.h, ServerView.cpp - the view of the document
    These files contain your CServerView class.
    CServerView objects are used to view CServerDoc objects.
